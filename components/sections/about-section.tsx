      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-12 md:mb-20">
        ...
        <div>
          ...
          <div className="space-y-4 text-muted-foreground text-base md:text-lg leading-relaxed">
            <p>
              Φτιάχνουμε εφαρμογές για web, mobile και desktop με έμφαση στον καθαρό κώδικα, τη σωστή αρχιτεκτονική και την καλή εμπειρία χρήστη.
            </p>
            <p>
              Τα τελευταία 10+ χρόνια έχουμε δουλέψει με startups και εταιρείες, μετατρέποντας ιδέες σε πραγματικά, 
              λειτουργικά προϊόντα που αντέχουν στον χρόνο. 
              Μας ενδιαφέρει να λύνουμε προβλήματα σωστά, όχι πρόχειρα, και να χτίζουμε πράγματα απλά, 
              κατανοητά και αξιόπιστα.
            </p>
            <p>
              Στον ελεύθερο χρόνο μας πειραματιζόμαστε με νέες τεχνολογίες, 
              συνεισφέρουμε σε open-source και μοιραζόμαστε γνώση με την κοινότητα.
            </p>
          </div>
        </div>
      </div>
