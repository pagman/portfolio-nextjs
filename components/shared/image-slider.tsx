...
export function ImageSlider({ images, alt }: ImageSliderProps) {
  ...
  if (images.length === 0) {
    return (
      <div className="rounded-2xl overflow-hidden shadow-2xl aspect-video flex items-center justify-center bg-white/3 border border-white/6">
        <div className="w-[80%] h-[85%] bg-white/5 rounded-lg" />
      </div>
    );
  }

  return (
    <div className="rounded-2xl overflow-hidden shadow-2xl aspect-video relative group bg-white/3">
      <Image
